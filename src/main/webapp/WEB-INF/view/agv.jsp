...
<html>
    ...
    <body>
        <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
            ...
            <symbol id="station" viewBox="0 0 16 16">
            ...
            <div class="container">
                ...
                <div class="row">
                    <!-- <div class="col map">
                        ...
                        <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 250 40" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
                            <line x1="-112.360777" y1="0" x2="112.360777" y2="0" transform="translate(125 20)" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <svg id="station1" width="32" height="32" fill="orange" viewBox="0 0 16 16">
                            <use xlink:href="#station"/>
                        </svg>
                        <svg id="station2" width="32" height="32" fill="orange" viewBox="0 0 16 16">
                            <use xlink:href="#station"/>
                        </svg>
                        <svg id="station3" width="32" height="32" fill="orange" viewBox="0 0 16 16">
                            <use xlink:href="#station"/>
                        </svg>
                        <svg id="station4" width="32" height="32" fill="orange" viewBox="0 0 16 16">
                            <use xlink:href="#station"/>
                        </svg>
                    </div> -->
                    <div class="col map">
