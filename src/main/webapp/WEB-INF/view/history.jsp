...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/yiddemoroomhistory.css">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/yiddemoroomhistory.js"></script>
    </head>
    <body>
        ...
        <main>
            <div class="d-flex flex-column flex-shrink-0" style="width: 5em;min-height: 100%;position: fixed;">
                ...
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/mvc/agv/history" class="nav-link py-3 active">
            ...
            <div class="container">
                <div class="row">
                    <div class="col Title">
                        <label class="title page">History</label>
                    </div>
                </div>

                <!-- <div class="row" style="height: 90%;padding:1.6em;padding-top: 0px;">
                    <div class="col" style="border-radius: 0.6rem!important;background-color: #5C5C5C;margin-right: 1.6em;">
                ...
                <div class="row" style="height: 90%;padding:1.6em;padding-top: 0px;">
                    <div class="col">
                        <div class="row">
                            <div class="col Title">
                                <label class="title">ALL Task Queue</label>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col Title">
                                <label class="title">ALL Notification</label>
                            </div>
                        </div>
                        <div class="row">
